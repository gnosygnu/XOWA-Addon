...
var EXPORTED_SYMBOLS = ["XowaPage"];

var XowaPage = 
{
    xowa_page_injection: function xowa_page_injection(window)
    {
        ...
        window.xowa_exec_async = function(/* function(result) */ _callback /* , arg1, arg2, ... */)
        {
            ...
            function(_result_type, _result, _connection_status) 
            {
                ...
                case "UNKNOWN_HOST":
                default:
                    Logger.error("xowa_exec :: connection problem - "+_connection_status+" after run "+cmd);
                    break;
                }
            });  
        };
